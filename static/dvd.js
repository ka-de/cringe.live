...
let showVector = true; // By default, the vector is shown
...
function draw() {
  ...
  if (showVector) {
    ctx.beginPath();
    drawArrow(x, y, x + dx * 20, y + dy * 20); // Multiply dx and dy by 20 for better visibility
    ctx.strokeStyle = 'red'; // Color of the vector
